    ...
    public static void main(String[] args) {
        ...
        while (opcao !=99999){
            ...
            while (opcao != soma){
                ...
                //Entrada de dados
                System.out.print("\nPara o Segundo teremos os : \n" + vencedor + "\n" + segundo); 
                
                System.out.print("\n\nOpções para o Segundo turno\n" + vencedor + " Digite <1> : " + "\n" + segundo + " Digite <2>: " + "\nVoto NULO   - Digite <0>:\nVoto BRANCO - Digite <9>: \n\nDIGITE SUA OPCAO: ");
                    opcao = ent.nextInt();
...
//                    if (cand1 > cand2) {
//                        System.out.println("O Candidato Eleito é : " + vence );
//                        System.out.println("O perdedor é : " + perde );
//                    }
//                    if (cand2 > cand1) {
//                            System.out.println("O Candidato Eleito é : " + perde );
//                            System.out.println("O perdedor é : " + vence );
//                    }
