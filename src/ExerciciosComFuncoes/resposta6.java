...
public class resposta6 {
    ...
    public static void main(String[] args) {
        ...
        while (hora <= 12){
            ...
            System.out.print("Digite horas e minutos hh:mm ");
                hora = ent.nextInt();
        
            System.out.print(":");
                int minu = ent.nextInt();
       
            if (hora < 12){
                System.out.print(hora + ":" + minu + " A.M.");            
            }   else if (hora > 12){
                    horamaior = hora - 12;
                }
            if (horamaior <= 12){
                System.out.print(hora + ":" + minu + " P.M.");
            }   else {
...
// http://wiki.python.org.br/ exzercicios